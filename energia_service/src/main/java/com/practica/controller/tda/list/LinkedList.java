...
public class LinkedList<E> {
    ...
    // metodo para particionar la lista en quicksort divide y venceras
    ...
    private void merge(E[] lista, Integer l, Integer m, Integer r, Integer type) {
        ...
        int k = l;
        while (i < n1 && j < n2) {
            Boolean condicion = (type == 1) ? (L[i].toString().compareTo(R[j].toString()) <= 0): (L[i].toString().compareTo(R[j].toString()) >= 0);
